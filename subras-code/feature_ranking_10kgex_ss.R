...
load("mountArvados/by_id/2de2948b2d44edcd781487cdfcbaea8c+1220/genes_80_01_6_10kgex.rda")

genes <- genes_10kgex

ge <- read.csv("mountArvados/by_id/59876256d61cf0596bd625a9f195660a+2629/pbmc10k_gex_filtered_scran.csv")
label_gex <- read.csv('mountArvados/by_id/fa4af28a57cad7c66d23b9fd5d702a28+1405/pbmc_10kgex_celltype_clean.csv')
...
for(j in 1:length(genes)){
	for(i in 1:length(genes)){
		if(genes[i] %in% gene_max_prev == FALSE ){
			...
			max.depth = 3, nthread = 4, nrounds = 50, objective = "multi:softmax", num_class = 9, verbose = 0 )#eta = 1 
...
png("xgboost_progressive_selection_80_3_01_6_10kgex.png",width=1000,height=600,unit="px")

print(p)

dev.off()

#"TYROBP", "CTSW", "MS4A1","CD8A", "IL7R", "FCN1", "NKG7", "CD3D", "CST3", "CD8B", "CD79A","IL32","GNLY", "CD4",  "CCL5", "FCER1G","CD3E", "KLRF1"